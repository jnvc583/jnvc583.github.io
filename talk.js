...
(function(){
    ...
    document.addEventListener('DOMContentLoaded', function(){
        ...
        style.textContent = '#talk-board .tb{border:1px solid #222;padding:12px;margin-top:12px;}#talk-board form input,#talk-board form textarea{width:100%;box-sizing:border-box;padding:8px;margin:6px 0;border:1px solid #444;}#talk-board .comment{border-top:1px solid #f0f0f0;padding:8px 0}#talk-board .meta{font-size:12px;color:rgb(0,225,161)}#talk-board .del{color:#c00;cursor:pointer;margin-left:8px} button[type="submit"]{background-color:#4CAF50;color:white;padding:10px 16px;border:none;border-radius:4px;cursor:pointer}button[type="submit"]:hover{background-color:#45a049}';
